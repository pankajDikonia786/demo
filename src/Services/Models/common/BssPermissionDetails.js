module.exports = async (sequelize2) => {
    ...
    const BssPermissionClassDorm = require("./BssPermissionClassDorm");

    const BssPermissionDetails = sequelize2.define("bss_permission_details", {
    ...
    BssPermissionDetails.hasMany(await BssPermissionClassDorm(sequelize2),
        {
            as: "perm_class_dorm", foreignKey: "user_id",
            sourceKey: "user_id",
            constraints: false, allowNull: true, defaultValue: null
        });
    return BssPermissionDetails;
}
